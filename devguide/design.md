...
- [ ] District system: 6 district types — Housing (provides housing for 5 pops, costs 100 minerals), Generator (produces 4 energy, costs 150 minerals), Mining (produces 4 minerals, costs 150 minerals), Agriculture (produces 6 food, costs 100 minerals), Industrial (produces 3 alloys, costs 200 minerals 50 energy), Research (produces 3 research each type, costs 200 minerals 100 energy). Districts occupy grid slots. Max districts = planet size (8-20). Build time: 300 ticks (30 seconds). First 3 districts on a new colony build at 50% time (150 ticks)
